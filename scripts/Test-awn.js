class TestController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "Test", options);
  }

  static importScripts (actx) {
    var origin = "https://jpauwels.github.io/wam-plugin/";
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/Test-WAM.wasm.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/Test-WAM.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/Test-awp.js").then(() => {
        resolve();
      }) }) }) });
    })
  }
